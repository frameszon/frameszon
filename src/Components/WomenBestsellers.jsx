...
const WomenBestsellers = () => {
  ...
  function Product(props) {
    return (
      <div className="p-4 md:h-60 shadow-lg rounded-2xl border-2 border-opacity-10 border-slate-500 lg:m-5 md:m-10 m-5 flex justify-center self-center align-middle items-center flex-col transition grow2 w-auto">
  ...
  return (
    <div className="justify-center items-center md:mb-32 mb-16">
